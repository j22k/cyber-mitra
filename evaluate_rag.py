...
def run_evaluation(faiss_index_dir, embedding_model_name, ollama_model_name):
    ...
    test_queries = [
        ...
        Believing its genuine, she enters her business registration number, PAN, and other 
        sensitive details. Later, she finds that someone has used these details to apply for 
        fraudulent loans in her businesss name""",
...
""" A young college student, Rohan, breaks up with his girlfriend, Sarah. Sarah 
then starts relentlessly harassing Rohan online, sending him abusive messages, 
threatening to share private photos (which she possesses), and even creating fake 
profiles to spread rumors about him to his friends and family.""",
